...
Plugin to enable EventBridge Schema Registry as a target in Hackolade data modeling.  Requires prior download of the Hackolade application from our [download page](https://hackolade.com/download.html)

This plugin is for OpenAPI 3 schemas stored in the Schema Registry of AWS EventBridge.  If instead you need Swagger 2, you need a separate plugin accessible [here](https://github.com/hackolade/Swagger) or standard OpenAPI, you need a separate plugin accessible [here](https://github.com/hackolade/OpenAPI). 
